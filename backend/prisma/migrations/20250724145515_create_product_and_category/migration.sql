/*
  ...
  - A unique constraint covering the columns `[productId,supplierId]` on the table `ProductSupplier` will be added. If there are existing duplicate values, this will fail.
